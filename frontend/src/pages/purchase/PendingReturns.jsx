...
import { fetchPendingReturns } from "../../api/purchases";
...
export default function PendingReturns() {
  ...
  const totalPending = returns.reduce((s, r) => s + Number(r.remaining_return || 0), 0);
      ...
      <div className="page-header">
        <div>
          <h1 className="page-title flex items-center gap-2">
            <Clock size={22} className="text-orange-500" /> Pending Purchase Returns
          </h1>
          <p className="page-sub">Supplier returns awaiting settlement</p>
        </div>
